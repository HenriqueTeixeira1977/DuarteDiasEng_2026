...
<head>
    <meta charset="UTF-8">
    <title>Duarte Dias Engenharia</title>
    ...
    <link rel="stylesheet" href="/public/assets/css/variable.css">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0 service-card">
                    <img src="public/img/projeto1.jpg" class="card-img-top">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0 service-card">
                    <img src="../../../public/img/projeto2.jpg" class="card-img-top">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0 service-card">
                    <img src="public/img/projeto3.jpg" class="card-img-top">
                    <div class="card-body">
        ...
        <div class="row g-4">
            <div class="col-md-3">
                <div class="counter-box">
                    <h2 class="fw-bold display-5 text-primary" data-counter="250">0</h2>
                    ...
                    <div class="col-md-3">
                        <div class="counter-box">
                            <h2 class="fw-bold display-5 text-primary" data-counter="120">0</h2>
        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="../../public/assets/img/proj1.jpg" class="w-100 slide-img">
                </div>
                <div class="swiper-slide">
                    <img src="../../public/assets/img/proj2.jpg" class="w-100 slide-img">
                </div>
                <div class="swiper-slide">
                    <img src="../../public/assets/img/proj3.jpg" class="w-100 slide-img">
                </div>
            </div>
